...
<body>
    ...
    <section>
        ...
        <div class="grid-container">
            ...
            <div>
                <img class="studentimg" id="studentimg" onclick="toStudent()" src="images/favicon.png" alt="Student" width="350" height="250px">
            </div>
                <div>
                <img class="facultyimg" id="facultyimg" onclick="toFaculty()" src="images/tapcard.png" alt="Faculty" width="350px" height="300px">
            </div>
            <div>
                <img class="visitorimg" id="visitorimg" onclick="toVisitor()" src="images/visitor.png" alt="Visitor" width="350px" height="300px">
            </div>
        </div>

        <div class="form-container" id="form-container" >
            <form class="studentform" id="studentform" style="display: none;" action="index.php" method="post">
                ...
                <button class="submitbt" type="submit" value="Submit" onclick="submitForm('student')">Submit</button> 
            </form>

            <form class="facultyform" id="facultyform" style="display: none;">
                <label for="department">Department:</label>
                <select id="department" name="department">
                    <option value="SON">SON</option>
                    <option value="SBMA">SBMA</option>
            ...
            <form class="visitorform" id="visitorform" style="display: none;">
                ...
                <button class="submitbt" type="submit" value="Submit" onclick="submitForm('visitor')">Submit</button> 
            </form>
        </div>
